...
@section('content')
    <div class="container mx-auto">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-purple-900 mb-6">Tasks</h1>
                ...
                <tbody class="divide-y divide-purple-300">
                    @forelse ($tasks as $task)
                        <tr class="hover:bg-purple-100">
                            ...
                            <td class="px-6 py-4">{{ $task->formatted_deadline }}</td>
                    ...
                    @empty
                        <tr>
                            <td class="px-6 py-4 text-center" colspan="7">No tasks found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
